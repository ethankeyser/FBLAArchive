...
Public Class Window7
    ...
    Private Sub NextWindow_Click(sender As Object, e As RoutedEventArgs)
        'increases the score when the answer is correct on this window so that extra points are not added when this window is closed and reopened
        If correct1 = True Then
            counter += 1
        End If

        'when the user clicks the next question button, the next window will be displayed 
        Dim ques2 As New Window2
        ques2.Show()
